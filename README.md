...
**BONUS:** If time allows pre cache your cat fact on each button click. For example - Your cat fact should come from the cache and in the background then get a new cat fact for the next time it is clicked ready for the next click.
